...
export default function ProductCard({
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      const topProducts = JSON.parse(localStorage.getItem('topPerformingProducts') || "[]"); // Corrected quotes
      ...
      const existingImpressions = JSON.parse(localStorage.getItem('productImpressions') || "[]"); // Corrected quotes
  ...
  const handleWishlist = (e: React.MouseEvent) => {
    ...
    if (typeof window !== 'undefined') {
      ...
      const existingWishlist = JSON.parse(localStorage.getItem('wishlistActions') || "[]"); // Corrected quotes
  ...
  const handleCompare = (e: React.MouseEvent) => {
    ...
    if (typeof window !== 'undefined') {
      ...
      const existingCompares = JSON.parse(localStorage.getItem('productComparisons') || "[]"); // Corrected quotes
  ...
  const handleQuickView = (e: React.MouseEvent) => {
    ...
    if (typeof window !== 'undefined') {
      ...
      const existingQuickViews = JSON.parse(localStorage.getItem('quickViews') || "[]"); // Corrected quotes
